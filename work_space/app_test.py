...
#df_refine.loc['created_at'] = df_refine['created_at'].astype(str)
#df_refine.loc['updated_at'].loc = df_refine['created_at'].astype(str)
...
raw_data.loc[(raw_data['milestone'] == 280) | (raw_data['milestone'] == 317) | (raw_data['milestone'] == 356)| (raw_data['milestone'] == 394),'milestone_unique']= 1
